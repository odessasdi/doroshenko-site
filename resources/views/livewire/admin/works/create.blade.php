<div class="space-y-6">
    <div class="flex items-start justify-between gap-4">
        <div>
            <h1 class="text-2xl font-semibold text-zinc-900">Create Work</h1>
            <p class="mt-1 text-sm text-zinc-600">Add a new work to the catalog.</p>
        </div>
        <a
            href="/admin/works"
    ...
    <form wire:submit="save" class="grid grid-cols-1 gap-6 lg:grid-cols-[1.2fr_0.8fr]">
        ...
        <div class="space-y-6">
            ...
            <div class="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
                ...
                <p class="mt-1 text-sm text-zinc-500">Up to 3 images.</p>
                <div class="mt-4 space-y-3">
                    <input
                        id="extra_images"
                        type="file"
