<div class="space-y-6">
    <div class="flex items-start justify-between gap-4">
        <div>
            <h1 class="text-2xl font-semibold text-zinc-900">Створити роботу</h1>
            <p class="mt-1 text-sm text-zinc-600">Додати нову роботу до каталогу</p>
        </div>
        <a
            href="/admin/works"
        ...
        <div class="space-y-6">
            <div class="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
                ...
                <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    @include('livewire.admin.works.partials.paper-presets', ['confirmOnChange' => false])
                    <div>
