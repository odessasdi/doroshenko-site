<div class="space-y-6">
    <div class="flex items-start justify-between gap-4">
        <div>
            <h1 class="text-2xl font-semibold text-zinc-900">Техніки</h1>
            <p class="mt-1 text-sm text-zinc-600">Керування списком технік.</p>
        </div>
        <button
            type="button"
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-[1.5fr_1fr]">
        <div class="overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm">
            <table class="min-w-full divide-y divide-zinc-200 text-sm">
                ...
                <tbody class="divide-y divide-zinc-200">
                            ...
                            <td class="px-4 py-3 text-right">
                                <div class="flex justify-end gap-2">
                                    ...
                                    <button
                                        ...
                                        onclick="if (!confirm('Видалити цю техніку?')) { event.stopImmediatePropagation(); event.preventDefault(); }"
                                    >
                                        Видалити
                                    </button>
                                </div>
                    ...
                    @empty
                        <tr>
                            <td class="px-4 py-6 text-center text-zinc-500" colspan="5">Поки що технік немає.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
        ...
        <div class="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
            <h2 class="text-lg font-semibold text-zinc-900">
                {{ $editingId ? 'Редагувати техніку' : 'Нова техніка' }}
            </h2>
